...
from tokentypes import TT_KEYWORD, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODUL, TT_POW, TT_ROOT, TT_EE, TT_EEE, TT_NE, TT_LT, TT_GT, TT_LTE, TT_GTE
		...
		if isinstance(other, Number):
			if other.value == 0:
				return None, RTError(
					...
					DivisionByZeroMessage[CURRENT_LANG],
					self.context
				)
